...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<title>Contratar Vehículo Terceros | TPO AD</title>
...
<body>
    ...
    <div class="row">
      <div class="col-sm-6">
        <h2>Contratar Vehículo Tercero</h2>
      </div>
    </div>
	      ...
	      <form action="./NuevoPedido" name="nuevoPedido" method="post">
			...
			<div class="panel-body">
				<div class="form-group">				
				  <label for="idPrecioVehiculo">Vehículo</label>
						<select class="selectpicker"  required>
					        ...
					        %>
						  <option  name="idPrecioVehiculo" data-tokens="<%= v.getTipoVehiculo()+" "+v.getIdPrecioVehiculo() %>" ><%= v.getTipoVehiculo()+" "+v.getIdPrecioVehiculo() %></option>
							<%}%>
						</select>
				</div>
				<div class="form-group">				
