...
if (action != null) {
	...
	try {
		...
		JsonElement element = gson.toJsonTree(list,
				new TypeToken<List<VehiculoDTO>>() {}.getType());
		...
		if (request.getParameter("trabajoEspecifico") != null) {
			...
			boolean b=false;
			if (trabajoEspecifico.equals("si")||trabajoEspecifico.equals("1")||trabajoEspecifico.equals("Si")||trabajoEspecifico.equals("SI")||trabajoEspecifico.equals("true"))
					b=true;
			else
				b=false;
		...
		if (request.getParameter("enGarantia") != null) {
			...
			boolean b=false;
			if (enGarantia.equals("si")||enGarantia.equals("1")||enGarantia.equals("Si")||enGarantia.equals("SI")||enGarantia.equals("true"))
					b=true;
			else
				b=false;
